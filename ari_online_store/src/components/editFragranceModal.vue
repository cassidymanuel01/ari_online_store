<template>
  <div class="modal fade" :id="'fragrance_'+album.id" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
...
export default {
    ...
    methods:{
        editItem(){
            this.$store.dispatch("editFragranceItem",this.album);
        }
    }
}
</script>
